      ...
      <div className="team-para">
        <div className='team'>
          <div className="team-member">
            <img src="/images/p1.jpeg" alt="Principal" className='abimg' />
            
            <h3>Principal</h3>
          </div>
          <div className="team-member">
            <img src="/images/p2.jpg" alt="Vice Principal" className='abimg' />
            <h3>Vice Principal</h3>
          </div>
        </div>
        <div  className="about-sec">
          <p1>In 29 years, FLS has gained a firm foothold on the national arena with new expansions in infrastructure and a dynamic curriculum

              The Future Leaders has revolutionized the way education is perceived and given it a new meaning and direction.
              ...
              Passion and potential and purpose find a new direction at FLS.
              A new generation of learners learning to expand their horizon, spread their wings towards change and empathy and empowerment. These trendsetters thus face life with finesse, elan and equanimity!</p1>
        </div>
      </div>
    </section>
  );
